...
public class BattleController {
     ...
     * La conversión se hace mediante un dto y un adapter externo, manteniendo el código limpio
     */
    @PostMapping("/start/external")
    public ResponseEntity<Map<String, Object>> startBattleFromExternal(
            @RequestBody ExternalBattleRequest body
    ) {
